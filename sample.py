...
# 模型文件夹
sample_conf.model_save_dir = "./models20190131/"
#/ \
# 图片相关参数
sample_conf.image_width = 122
sample_conf.image_height = 54
...
sample_conf.remote_url = "http://jw.zhku.edu.cn/sys/ValidateCode.aspx"
